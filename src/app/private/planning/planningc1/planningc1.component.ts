// planningc1.component.ts - Client Passes First Scenario
...
@Component({
  selector: 'app-planningc1',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './planningc1.component.html',
  styleUrls: ['./planningc1.component.css'],
})
export class Planningc1Component implements OnInit {
  @Input() normalizedAssets!: NormalizedAssets;
  @Input() clientName: string = 'Client';
  @Input() spouseName: string = 'Spouse';

  scenario: ClientPassesFirstScenario | null = null;
  ...
  ngOnInit(): void {
    if (this.normalizedAssets) {
      ...
      this.scenario = this.scenarioService.generateClientPassesFirst(this.normalizedAssets);
    }
  }
