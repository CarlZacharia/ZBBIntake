...
-- =====================================================
-- This schema supports the TypeScript interfaces defined in the Angular application
-- Designed for optimal performance and data integrity

-- Create database
CREATE DATABASE IF NOT EXISTS zbbintake
...
-- Portal Users table (Front-end Authentication)
...
-- Previous marriages
CREATE TABLE previous_marriages (
...
CREATE TABLE facility_referrals (
    ...
    facility_name VARCHAR(255),
    case_type ENUM('Guardianship','Medicaid','Both') NULL,
    ...
    spouse_name_encrypted TEXT,
    spouse_address_encrypted TEXT,
    spouse_phone_encrypted TEXT,
    spouse_email_encrypted TEXT,
    spouse_dob DATE,
    spouse_age INT,
    spouse_sex VARCHAR(20),
    spouse_living_conditions VARCHAR(50),
    spouse_health_encrypted TEXT,
...
CREATE TABLE guardianship_details (
...
CREATE TABLE beneficiaries (
    ...
    -- Ensure percentages don't exceed 100% per asset and category
...
CREATE INDEX idx_children_case_name ON children(case_id, legal_last_name, legal_first_name);

-- Create full-text indexes for search functionality
ALTER TABLE personal_info ADD FULLTEXT(legal_first_name, legal_last_name, preferred_name);
ALTER TABLE children ADD FULLTEXT(legal_first_name, legal_last_name);
ALTER TABLE charities ADD FULLTEXT(organization_name, mission_description);

-- =====================================================
-- SAMPLE DATA (Optional - for testing)
-- =====================================================

-- Insert sample user (password should be hashed in real implementation)
-- INSERT INTO users (email, password_hash, first_name, last_name, email_verified, profile_completed)
-- VALUES ('test@example.com', '$2b$10$...', 'John', 'Doe', TRUE, FALSE);

-- =====================================================
-- SECURITY & MAINTENANCE
-- =====================================================

-- Create database user for application (run separately with proper credentials)
-- CREATE USER 'zbb_app'@'localhost' IDENTIFIED BY 'secure_password_here';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON zbbintake.* TO 'zbb_app'@'localhost';
-- FLUSH PRIVILEGES;
...
-- =====================================================
/*
1. Encryption fields (ssn_encrypted, account_number_encrypted, etc.) should be encrypted at application level
2. Implement proper backup strategy for production
3. Consider partitioning large tables by date if needed
4. Set up monitoring for performance and security
5. Implement proper data retention policies
6. Consider adding database-level encryption for sensitive data
7. Set up regular maintenance tasks (OPTIMIZE TABLE, etc.)
